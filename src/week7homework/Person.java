...
Note:in total,you have to write 8 method
 */

public class Person {
    private String firstName;//variables create with private modifier
    private String lastName;
    private int age;

    public Person(String firstName, String lastName, int age) {
        this.firstName = firstName;//constructor created
   ...
   public String getFirstName() {
        ...
        return firstName;
    }//get method without any parameter
    ...
    public int getAge() {//getAge without any parameters with return value

        return age;
    }

    public void setFirstName(String firstName) {//set method with one parameter of type String

        this.firstName = firstName;
    }

    public void setLastName(String lastName) {//set method with one parameter of type of string
